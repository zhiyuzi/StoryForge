...
<p align="center">
  基于 Claude Code 的 Agent Runtime，用 Harness Engineering 管理不确定性计算
</p>
...
- 想把内容生成任务做成有控制点工作流的人
- 对 Harness Engineering 在不确定性计算中的应用感兴趣的人
